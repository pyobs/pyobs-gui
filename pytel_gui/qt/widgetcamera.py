...
class Ui_WidgetCamera(object):
    def setupUi(self, WidgetCamera):
        ...
        self.spinWindowWidth = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.spinWindowHeight = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.spinWindowLeft = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.spinWindowTop = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.butFullFrame = QtWidgets.QPushButton(self.groupBox)
        ...
        self.spinBinningY = QtWidgets.QSpinBox(self.groupBox_2)
        ...
        self.spinBinningX = QtWidgets.QSpinBox(self.groupBox_2)
        ...
        self.comboImageType = QtWidgets.QComboBox(self.groupBox_3)
        ...
        self.spinCount = QtWidgets.QSpinBox(self.groupBox_3)
        ...
        self.spinExpTime = QtWidgets.QSpinBox(self.groupBox_3)
        ...
        self.butExpose = QtWidgets.QPushButton(self.groupBox_3)
        ...
        self.butAbort = QtWidgets.QPushButton(self.groupBox_3)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
    ...
    def retranslateUi(self, WidgetCamera):
        ...
        self.groupBox.setTitle(_translate("WidgetCamera", "Window"))
        ...
        self.groupBox_2.setTitle(_translate("WidgetCamera", "Binning:"))
        self.label_6.setText(_translate("WidgetCamera", "Y:"))
        self.label_5.setText(_translate("WidgetCamera", "X:"))
        self.groupBox_3.setTitle(_translate("WidgetCamera", "Exposure"))
