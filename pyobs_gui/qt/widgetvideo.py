...
class Ui_WidgetVideo(object):
    def setupUi(self, WidgetVideo):
        ...
        self.gridLayout_4.addLayout(self.layoutExpTime, 0, 1, 1, 1)
        self.labelExpTime = QtWidgets.QLabel(self.groupExposure)
        self.labelExpTime.setObjectName("labelExpTime")
        self.gridLayout_4.addWidget(self.labelExpTime, 0, 0, 1, 1)
    ...
    def retranslateUi(self, WidgetVideo):
        ...
        self.comboExpTimeUnit.setItemText(0, _translate("WidgetVideo", "s"))
        self.comboExpTimeUnit.setItemText(1, _translate("WidgetVideo", "ms"))
        self.comboExpTimeUnit.setItemText(2, _translate("WidgetVideo", "µs"))
