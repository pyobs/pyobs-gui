...
class Ui_WidgetTelescope(object):
    def setupUi(self, WidgetTelescope):
        ...
        self.butMoveAltAz = QtWidgets.QPushButton(self.groupBox_3)
        self.butMoveAltAz.setObjectName("butMoveAltAz")
        self.gridLayout_3.addWidget(self.butMoveAltAz, 2, 1, 1, 1)
    ...
    def retranslateUi(self, WidgetTelescope):
        ...
        self.butMoveAltAz.setText(_translate("WidgetTelescope", "Move"))
