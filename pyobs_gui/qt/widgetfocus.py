...
class Ui_WidgetFocus(object):
    def setupUi(self, WidgetFocus):
        ...
        sizePolicy.setHeightForWidth(
            self.labelCurFocus.sizePolicy().hasHeightForWidth()
        )
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.labelCurFocus
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.labelCurFocusBase.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.labelCurFocusOffset.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.labelCurStatus.sizePolicy().hasHeightForWidth()
        )
        ...
        self.formLayout.setWidget(
            3, QtWidgets.QFormLayout.FieldRole, self.labelCurStatus
        )
