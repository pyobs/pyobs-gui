...
class Ui_ModeWidget(object):
    def setupUi(self, ModeWidget):
        ...
        self.textFilter = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.buttonSetFilter = QtWidgets.QToolButton(self.groupBox)
        icon = QtGui.QIcon()
    ...
    def retranslateUi(self, ModeWidget):
        ...
        self.label_9.setText(_translate("ModeWidget", "Filter:"))
        self.buttonSetFilter.setText(_translate("ModeWidget", "set..."))
