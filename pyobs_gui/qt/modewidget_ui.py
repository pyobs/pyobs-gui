...
from PySide6.QtWidgets import QApplication, QFormLayout, QGroupBox, QLabel, QLineEdit, QSizePolicy, QVBoxLayout, QWidget
...
class Ui_ModeWidget(object):
    ...
    def retranslateUi(self, ModeWidget):
        ModeWidget.setWindowTitle(QCoreApplication.translate("ModeWidget", "Form", None))
        self.groupBox.setTitle(QCoreApplication.translate("ModeWidget", "Modes", None))
        self.label_11.setText(QCoreApplication.translate("ModeWidget", "Status:", None))
