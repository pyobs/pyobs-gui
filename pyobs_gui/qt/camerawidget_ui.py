...
class Ui_CameraWidget(object):
    def setupUi(self, CameraWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 239, 748))
        ...
        self.buttonSetGain = QtWidgets.QToolButton(self.groupGain)
        icon = QtGui.QIcon()
        ...
        self.textGain = QtWidgets.QLineEdit(self.groupGain)
        ...
        self.label_13 = QtWidgets.QLabel(self.groupGain)
        ...
        self.textOffset = QtWidgets.QLineEdit(self.groupGain)
        ...
        self.buttonSetOffset = QtWidgets.QToolButton(self.groupGain)
        ...
        self.labelExposuresLeft.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
    ...
    def retranslateUi(self, CameraWidget):
        ...
        self.buttonSetGain.setText(_translate("CameraWidget", "..."))
        self.label_11.setText(_translate("CameraWidget", "Gain:"))
        self.label_13.setText(_translate("CameraWidget", "Offset:"))
        self.buttonSetOffset.setText(_translate("CameraWidget", "..."))
